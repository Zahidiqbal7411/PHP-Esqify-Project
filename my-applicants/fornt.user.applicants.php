...
=======
            SELECT id FROM new_users WHERE CONCAT(first_name, ' ', last_name) LIKE :name
...
=======
            SELECT id FROM new_users WHERE email = :email
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
        )";
...
=======
            SELECT id FROM new_users WHERE phone = :phone
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
        )";
...
=======
    $countSql = "SELECT COUNT(*) FROM job_applications ja JOIN new_users u ON ja.applicant_id = u.id $where";
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
...
=======
    $sql = "SELECT ja.*, u.first_name, u.last_name, u.email, u.phone FROM job_applications ja JOIN new_users u ON ja.applicant_id = u.id $where ORDER BY $sortField $sortOrder LIMIT :limit OFFSET :offset";
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
