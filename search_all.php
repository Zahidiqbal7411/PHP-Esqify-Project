...
=======
function attachUserRelations(PDO $conn, array $row, $userIdField = 'owner', $usersTable = 'new_users', $cityTable = 'citys') {
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
...
=======
               FROM new_users WHERE deleted_at IS NULL AND role_id = 3";
>>>>>>> 9c6d471 (Created some new API's & fixed issues in some API's)
    $peoplesParams = [];
    if ($hasSearch) {
        $peoplesSql .= " AND (
