...
// Pagination params (from POST only)
...
=======
        FROM referrals r
    JOIN new_users u ON r.user_id = u.id
        LEFT JOIN industrys i ON r.industry = i.id
        LEFT JOIN new_users ow ON r.owner = ow.id
        LEFT JOIN new_users ref ON r.referred_by = ref.id
